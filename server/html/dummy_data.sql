...
insert into users (username, password) values ("mousemashiSix9", "password123");
...
select userID into @user3 from users where username="mousemashiSix9";
...
insert into borks(userID, bork) values(@user3, "Judaism, where are you? Where are you Judaism?");
